...
export default function WhyChooseUs() {
    return (
        <section className="w-full py-12 md:py-16 lg:py-16 xl:py-16 2xl:py-20 px-4 md:px-12 xl:px-16 2xl:px-20 bg-white">
            <div className="container mx-auto">
                ...
                {/* Main Layout */}
                <Reveal className="relative flex flex-col md:flex-row justify-center items-center md:items-start max-w-6xl xl:max-w-7xl mx-auto gap-8 md:gap-0">

                    {/* LEFT CONTENT - Desktop */}
                    <div className="hidden md:flex flex-col justify-between text-right w-1/3 pr-4 lg:pr-8 xl:pr-10 h-[460px] xl:h-[460px] 2xl:h-[500px]">
                        <div className="pt-10 xl:pt-12">
                            <h3 className="text-lg lg:text-xl 2xl:text-2xl xl:text-xl font-semibold mb-1 xl:mb-2">Sustainable Practices</h3>
                        ...
                        <div className="pb-10 xl:pb-12">
                            <h3 className="text-lg lg:text-xl 2xl:text-2xl xl:text-xl font-semibold mb-1 xl:mb-2">Customer Commitment</h3>
                            <p className="text-sm xl:text-base 2xl:text-lg text-gray-600">
                    ...
                    {/* CENTER IMAGE */}
                    <div className="relative w-[280px] h-[380px] sm:w-[320px] sm:h-[420px] md:w-[360px] md:h-[460px] xl:w-[400px] xl:h-[460px] 2xl:w-[440px] 2xl:h-[500px] flex-shrink-0">
                        <Image
                        ...
                        {/* LEFT ICONS */}
                        <div className="absolute top-10 left-0 -translate-x-1/2 w-16 h-16 xl:w-16 xl:h-16 2xl:w-20 2xl:h-20 bg-[#1338BE] flex items-center justify-center shadow">
                        ...
                        <div className="absolute bottom-10 left-0 -translate-x-1/2 w-16 h-16 xl:w-16 xl:h-16 2xl:w-20 2xl:h-20 bg-[#1338BE] flex items-center justify-center shadow">
                        ...
                        {/* RIGHT ICONS */}
                        <div
                            className="absolute top-10 right-0 translate-x-1/2 w-16 h-16 xl:w-16 xl:h-16 2xl:w-20 2xl:h-20 flex items-center justify-center shadow"
                        ...
                        <div className="absolute bottom-10 right-0 translate-x-1/2 w-16 h-16 bg-[#1338BE]  flex items-center justify-center shadow">
                            <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="hidden md:flex flex-col justify-between text-left w-1/3 pl-4 lg:pl-8 xl:pl-10 h-[460px] xl:h-[460px] 2xl:h-[500px]">
                        <div className="pt-10 xl:pt-12">
                            <h3 className="text-lg lg:text-xl 2xl:text-2xl xl:text-xl font-semibold mb-1 xl:mb-2">Certified Quality</h3>
                            <p className="text-sm xl:text-base 2xl:text-lg text-gray-600">
                        ...
                        <div className="pb-10 xl:pb-12">
                            <h3 className="text-lg lg:text-xl 2xl:text-2xl xl:text-xl font-semibold mb-1 xl:mb-2">35+ Years Experience</h3>
                            <p className="text-sm xl:text-base 2xl:text-lg text-gray-600">
                ...
                <div className="md:hidden mt-12 space-y-8 max-w-md mx-auto">
                    <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-[#1338BE] flex items-center justify-center shadow flex-shrink-0">

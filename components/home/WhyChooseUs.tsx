            ...
            <div className="container mx-auto">
                ...
                <Reveal className="relative flex flex-col md:flex-row justify-center items-center md:items-start max-w-6xl xl:max-w-7xl mx-auto gap-8 md:gap-0">
                    ...
                    <div className="relative w-[280px] h-[380px] sm:w-[320px] sm:h-[420px] md:w-[360px] md:h-[460px] xl:w-[400px] xl:h-[460px] 2xl:w-[440px] 2xl:h-[500px] flex-shrink-0">
                        ...
                        {/* LEFT ICONS */}
                        <div className="absolute top-10 left-0 -translate-x-1/2 w-16 h-16 xl:w-16 xl:h-16 2xl:w-20 2xl:h-20 bg-[#ECF0F1] flex items-center justify-center shadow">
                        ...
                        <div className="absolute bottom-10 left-0 -translate-x-1/2 w-16 h-16 xl:w-16 xl:h-16 2xl:w-20 2xl:h-20 bg-[#ECF0F1] flex items-center justify-center shadow">

        ...
        <footer className="w-full">
            ...
            <div className="w-full py-12 md:py-16 px-4 md:px-8 lg:px-12" style={{ backgroundColor: bgColor }}>
                <div className="container mx-auto max-w-7xl text-white">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12 pb-10 md:pb-12">
                    ...
                    {/* Contact Info Row */}
                    <div className="">
                        <h4 className="text-lg md:text-xl font-bold mb-4 pb-2 relative inline-block">
                            Contact Info
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-4">
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <p className="text-sm md:text-base">+92 21-32441116-9</p>
                            </div>
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <p className="text-sm md:text-base">+92 21-32441276</p>
                            </div>
                            ...
                            <div className="flex gap-3 items-center">
                                ...
                                <p className="text-sm md:text-base">info@mandviwalla.net</p>
                            </div>
                        </div>
                    </div>
                </div>

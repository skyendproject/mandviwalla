...
export default function Footer({ variant = "blue" }: FooterProps) {
    ...
    return (
        <footer className="w-full">
            {/* Main Footer */}
            <div className="w-full py-12 md:py-16 px-4 md:px-8 lg:px-12" style={{ backgroundColor: bgColor }}>
                <div className="container mx-auto max-w-7xl text-white">
                    {/* Main Row: Logo + Nav + SECP/Jama */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12 pb-4 md:pb-6">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-sm md:text-base">Plastic Industries Limited</p>
                            </div>
                            ...
                            {/* Contact Info (heading stays here, items break out into a row) */}
                            <div className="mt-6 flex flex-col gap-3">
                                <h4 className="text-lg md:text-xl font-bold mb-1 pb-2 relative">
                                    Contact Info
                                    <span className="absolute bottom-0 left-0 h-0.5 w-[60px]" style={{ backgroundColor: colors.orange.dark }}></span>
                                </h4>

                                <div className="flex flex-wrap gap-x-8 gap-y-3 lg:w-max lg:max-w-[calc(100vw-6rem)]">
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <p className="text-sm md:text-base whitespace-nowrap">+92 21-32441116-9</p>
                                    </div>
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <p className="text-sm md:text-base whitespace-nowrap">+92 21-32441276</p>
                                    </div>
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <p className="text-sm md:text-base whitespace-nowrap">info@mandviwalla.net</p>
                                    </div>
                            </div>
                        </div>

                        {/* Nav dropdowns (internal 2-col grid) */}
                        <div className="sm:col-span-2 lg:col-span-2">
                            <FooterNavDropdowns />
                        </div>

                        {/* SECP + Jama Punji stacked */}
                        <div className="flex flex-col gap-10 sm:col-span-2 lg:col-span-1">
                            <div className="flex flex-col gap-3">
                                <h4 className="text-lg md:text-xl font-bold mb-1 pb-2 relative">
                                    <Link href="/secp-services-desk" className="no-underline hover:no-underline">
                                        SECP – Services Desk
                                    </Link>
                                    <span className="absolute bottom-0 left-0 h-0.5 w-[30%]" style={{ backgroundColor: colors.orange.dark }}></span>
                                </h4>
                                <Link href="/secp-services-desk" className="block w-fit">
                                    <Image
                                        src="/assets/secp-service-desk.jpeg"
                                        alt="SECP Service Desk"
                                        width={360}
                                        height={110}
                                        className="w-full max-w-xs h-auto bg-white rounded-md p-2"
                                    />
                                </Link>
                                <Link
                                    href="/secp-services-desk"
                                    className="text-sm md:text-base hover:translate-x-1 transition-transform inline-flex items-center gap-2"
                                >
                            ...
                            <div className="flex flex-col gap-3">
                                <h4 className="text-lg md:text-xl font-bold mb-1 pb-2 relative">
                                    <Link href="/jama-punji" className="no-underline hover:no-underline">
                                        Jama Punji
                                    </Link>
                                    <span className="absolute bottom-0 left-0 h-0.5 w-[30%]" style={{ backgroundColor: colors.orange.dark }}></span>
                                </h4>
                                <Link href="/jama-punji" className="block w-fit">
                                    <Image

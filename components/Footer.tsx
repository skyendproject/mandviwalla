                ...
                <div className="container mx-auto max-w-7xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12 text-white">
                        ...
                        <div className="flex flex-col gap-4">
                            <h4 className="text-lg md:text-xl font-bold mb-2 pb-2 relative">
                                Contact Info
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <Link href="#" className="flex gap-3 items-center hover:translate-x-1 transition-transform">
                                <ArrowRight size={18} style={{ color: colors.orange.dark }} />
                                <span className="text-sm md:text-base">Our Products</span>
                            </Link>

                            <Link href="#" className="flex gap-3 items-center hover:translate-x-1 transition-transform">
                                <ArrowRight size={18} style={{ color: colors.orange.dark }} />
                                <span className="text-sm md:text-base">Election of Director</span>
                            </Link>

                            <Link href="#" className="flex gap-3 items-center hover:translate-x-1 transition-transform">
                                <ArrowRight size={18} style={{ color: colors.orange.dark }} />
                                <span className="text-sm md:text-base">FAQ's</span>
                            </Link>

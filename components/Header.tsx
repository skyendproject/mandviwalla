...
export default function Header() {
    ...
    return (
        <header className="w-full border-b relative z-50">
            ...
            {/* Orange top strip hidden site-wide per request; keep code for future re-enable. */}
            {false && (
            <div className="hidden lg:block w-full text-white text-sm py-2 px-4 md:px-20" style={{ backgroundColor: colors.orange.dark }}>
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4 md:gap-6 ml-auto md:ml-0">
                        <div className="flex gap-4 md:gap-6 font-semibold text-sm">
            ...
            <div className="hidden lg:block w-full py-1 bg-white border-b px-4 md:px-20">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col text-base sm:text-lg lg:text-xl">
                            <h2 className="font-bold">Mandviwalla <span style={{ color: colors.orange.dark }}>MAUSER</span></h2>
                            <h3 className="text-sm md:text-base">Plastic Industries Limited</h3>
                        </div>
                    </div>
      ...
      opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50" style={{ backgroundColor: colors.primary.blue }}>
          ...
          opacity-0 invisible group-hover/govern:opacity-100 group-hover/govern:visible transition-all" style={{ backgroundColor: colors.primary.blue }}>
                                            ...
                                            <li>
                                                <Link href="/tax-consultant" className="block px-4 py-2 transition uppercase" onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.blue.primary} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                                                    Tax Consultant
                                                </Link>
                                            </li>
                                        </ul>
                                    ...
                                    <li className="relative group/invest">
                                        <Link href="/corporate-briefing-session" className="flex justify-between items-center px-4 py-2 transition uppercase" onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.blue.primary} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                                            INVESTOR RELATION
                                            <ChevronDown size={14} className="ml-2" />
                                        </Link>
          ...
          opacity-0 invisible group-hover/invest:opacity-100 group-hover/invest:visible transition-all" style={{ backgroundColor: colors.primary.blue }}>
                                            <li>
                                                <Link href="/corporate-briefing-session" className="block px-4 py-2 transition uppercase" onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.blue.primary} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                    ...
                    <Link
                        ...
                        style={{ backgroundColor: colors.orange.dark, color: '#ffffff' }}

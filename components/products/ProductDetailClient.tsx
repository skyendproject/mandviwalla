      ...
      <div className="max-w-5xl w-full relative mt-8">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="mb-2">
              ...
              <ul className="list-disc pl-5 text-sm mt-1 mb-2">
                {product.details.features.map((f: string, i: number) => (
                  <li key={i}>{f}</li>
                ))}
              </ul>
            </div>
            <div className="mb-2">
              ...
              <ul className="list-none pl-0 text-sm mt-1">
                {product.details.sizes.map((s: string, i: number) => (
                  <li key={i}>{s}</li>
                ))}
              </ul>
            </div>
        ...
        <div className="max-w-5xl w-full mt-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl md:text-3xl font-semibold">Related Product</h2>
